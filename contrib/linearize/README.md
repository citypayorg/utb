# Linearize
Construct a linear, no-fork, best version of the Utb blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install utb_hash

https://github.com/utbpay/utb_hash
...
JSON-RPC server. Running `utbd` or `utb-qt -server` will be sufficient.
...
* `input`: utbd blocks/ directory containing blkNNNNN.dat
