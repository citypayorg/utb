/* src/config/utb-config.h.  Generated from utb-config.h.in by configure.  */
/* src/config/utb-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Utb Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Utb Core"
...
#define PACKAGE_BUGREPORT "https://github.com/utbpay/utb/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Utb Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Utb Core 0.14.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "utbcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://jdjpay.org/"
