...
space *do not upload these to the ctp.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the ctp.org server

- Update ctp.org

- Announce the release:

  - Release on Ctp forum: https://www.ctp.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Ctppay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~ctp.org/+archive/ubuntu/ctp)
