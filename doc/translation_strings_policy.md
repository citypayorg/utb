...
This document provides guidelines for internationalization of the Utb Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `utb_en.ts` remains unchanged.
