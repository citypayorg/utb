...
official/supported Docker Images found at https://hub.docker.com/r/ctppay/ctpd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/ctppay/ctpd-develop/ when changing the above text**