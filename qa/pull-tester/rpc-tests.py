...
BASE_SCRIPTS= [
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs ctp_hash to pass
    'llmq-chainlocks.py', # NOTE: needs ctp_hash to pass
    'llmq-simplepose.py', # NOTE: needs ctp_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs ctp_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs ctp_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs ctp_hash to pass
...
ZMQ_SCRIPTS = [
    # ZMQ test can only be run if Ctp Core was built with zmq-enabled.
...
def run_tests(test_list, src_dir, build_dir, exeext, jobs=1, enable_coverage=False, args=[]):
    ...
    if "BITCOIND" not in os.environ:
        os.environ["BITCOIND"] = build_dir + '/src/ctpd' + exeext
